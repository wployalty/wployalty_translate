...
class Router
{
    ...
    public function initHooks()
    {
        ...
        if (is_admin() && (self::$controller->isPluginIsActive('wp-loyalty-rules/wp-loyalty-rules.php') || self::$controller->isPluginIsActive('wp-loyalty-rules-lite/wp-loyalty-rules-lite.php'))) {
